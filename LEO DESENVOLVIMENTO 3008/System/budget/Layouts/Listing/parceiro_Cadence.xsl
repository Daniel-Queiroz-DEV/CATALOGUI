										...
										<tbody>
											<tr>
												<td style="PADDING-RIGHT: 10px; PADDING-LEFT: 10px; PADDING-BOTTOM: 10px; PADDING-TOP: 10px" width="1%">
													<img src="%pastasistema%/identity/parceiro_cadence.png" width="100" />
												</td>
												<td style="PADDING-RIGHT: 10px; PADDING-LEFT: 10px; PADDING-BOTTOM: 10px; PADDING-TOP: 10px" valign="top">
													<table cellspacing="0" cellpadding="3" width="100%" border="0">
														<tbody>
															...
															<tr>
																<td width="100%" align="left" style="color:#535353;"><b>Nome:</b> Cadence </td>
															</tr>
															<tr>
																<td width="100%" align="left" style="color:#535353;"><b>Fone:</b> (54) 3290 2200 </td>
															</tr>
															<tr>
																<td width="100%" align="left" style="color:#535353;"><b>Website:</b> http://www.cadence.com.br </td>
															</tr>
														</tbody>
													</table>
												</td>
