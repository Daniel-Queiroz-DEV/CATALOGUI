										...
										<tbody>
											<tr>
												<td style="PADDING-RIGHT: 10px; PADDING-LEFT: 10px; PADDING-BOTTOM: 10px; PADDING-TOP: 10px" width="1%">
													<img style="WIDTH: 100px; HEIGHT: 36px" height="27" src="%pastasistema%/identity/logoVenax.jpg" width="100">
													</img> 
												</td>
