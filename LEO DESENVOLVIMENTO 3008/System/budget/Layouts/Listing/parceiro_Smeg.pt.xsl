				...
				<tr>
					<td align="center">
						<table width="630" border="1" borderColor="#dfdfdf"  bgcolor="#EEEEEE" style="border 1px Solid #535353;border-collapse:collapse;">
							<tr>
								<td width="1%" style="padding:10px;"><img src="%pastasistema%\Identity\logoSmeg.jpg" width="100" height="30"/></td>
								<td style="padding:10px;" valign="top">
									<table cellspacing="0" cellpadding="3" border="0" width="100%">
										...
										<tr>
											<td width="100%" align="left" style="color:#535353;"><b>Nome:</b> Smeg do Brasil</td>
										</tr>
										<tr>
										...
										<tr>
											<td width="100%" align="left" style="color:#535353;"><b>E-mail:</b> info@Smeg.com.br</td>
										</tr>
										<tr>
											<td width="100%" align="left" style="color:#535353;"><b>Website:</b> www.Smeg.com.br</td>
										</tr>
									</table>
								</td>
							</tr>
