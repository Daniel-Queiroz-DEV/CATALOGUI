	...
	<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
		...
		<xsl:template match="LISTING">
			<html generator="ProMob.Cadastro">
				<head>
					<title>Parceiro Madelustre</title>
										...
										<tbody>
											<tr>
												<td style="PADDING-BOTTOM: 10px; PADDING-LEFT: 10px; PADDING-RIGHT: 10px; PADDING-TOP: 10px" width="1%">
													<img src="%pastasistema%/identity/logomadelustre.jpg">
													</img> 
												</td>
													...
													<table border="0" cellspacing="0" cellpadding="3" width="100%">
														<tbody>
															...
															<tr>
																<td style="COLOR: #535353" width="100%" align="left">
																	<b>Endereço:
																	</b>  Rua: Cristóvao Colombo 190; Bairro: Santa Terezinha - Garibaldi/RS
															...
															<tr>
																<td style="COLOR: #535353" width="100%" align="left">
																	<b>E-mail: madelustre@madelustre.com.br
																	</b>
																</td>
															</tr>
															<tr>
