<?xml version="1.0" encoding="utf-8"?>
	<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
		...
		<xsl:template match="LISTING">
			...
			<html>
				<head>
					...
					<link href="%pastasistema%\Budget\Layouts\Listing\Parceiro.css" rel="stylesheet" type="text/css"/>					
				</head>
				...
				<tr>
					<td align="center">
						<table width="630" border="1" borderColor="#dfdfdf"  bgcolor="#EEEEEE" style="border 1px Solid #535353;border-collapse:collapse;">
							<tr>
								<td width="1%" style="padding:10px;"><img src="%pastasistema%\Identity\logoFranke.jpg" width="100" height="32"/></td>
								<td style="padding:10px;" valign="top">
									<table cellspacing="0" cellpadding="3" border="0" width="100%">
										...
										<tr>
											<td width="100%" align="left" style="color:#535353;"><b>Nome:</b> Franke </td>
										</tr>
										<tr>
											<td width="100%" align="left" style="color:#535353;"><b>Contato:</b> 0800-477300 e solicite o representante de sua região</td>
										</tr>
										<tr>
											<td width="100%" align="left" style="color:#535353;"><b>Telefone:</b> +55 47 3431-0544</td>
										</tr>
										<tr>
											<td width="100%" align="left" style="color:#535353;"><b>E-mail:</b> marcelo.maia@franke.com </td>
										</tr>
										<tr>
											<td width="100%" align="left" style="color:#535353;"><b>Website:</b> www.franke.com.br</td>
										</tr>
									</table>
								</td>
							</tr>
						...
						<table width="100%" cellspacing="5" cellpadding="2" border="0">
							<tr>
								<td style="font-size:10px;"><b><span style="color:#535353;">Nome:</span></b>
									<xsl:value-of select="CUSTOMERSDATA/DATA[@ID='rep_nomeloja']/@VALUE"/>
								</td>		
								<td style="font-size:10px;"><b><span style="color:#535353;">CNPJ:</span></b>
									<xsl:value-of select="CUSTOMERSDATA/DATA[@ID='rep_cnpjloja']/@VALUE"/>
								</td>									
							</tr>
							<tr>
								<td style="font-size:10px;"><b><span style="color:#535353;">Endereço:</span></b>
									<xsl:value-of select="CUSTOMERSDATA/DATA[@ID='rep_endloja']/@VALUE"/>
								</td>								
							</tr>
							<tr>
								<td style="font-size:10px;"><b><span style="color:#535353;">Bairro:</span></b>
									<xsl:value-of select="CUSTOMERSDATA/DATA[@ID='rep_bairroloja']/@VALUE"/>
								</td>
								<td style="font-size:10px;"><b><span style="color:#535353;">CEP:</span></b>
									<xsl:value-of select="CUSTOMERSDATA/DATA[@ID='rep_ceploja']/@VALUE"/>
								</td>
							</tr>
							<tr>
								<td style="font-size:10px;"><b><span style="color:#535353;">Cidade:</span></b>
									<xsl:value-of select="CUSTOMERSDATA/DATA[@ID='rep_cidadeloja']/@VALUE"/>
								</td>
								<td style="font-size:10px;"><b><span style="color:#535353;">UF:</span></b>
									<xsl:value-of select="CUSTOMERSDATA/DATA[@ID='rep_ufloja']/@VALUE"/>
								</td>								
							</tr>
							<tr>
								<td style="font-size:10px;"><b><span style="color:#535353;">Telefone:</span></b>
									<xsl:value-of select="CUSTOMERSDATA/DATA[@ID='rep_foneloja']/@VALUE"/>
								</td>	
								<td style="font-size:10px;"><b><span style="color:#535353;">E-mail:</span></b>
									<xsl:value-of select="CUSTOMERSDATA/DATA[@ID='rep_emailloja']/@VALUE"/>
								</td>	
							</tr>
							<tr>
								<td style="font-size:10px;"><b><span style="color:#535353;">Website:</span></b>
									<xsl:value-of select="CUSTOMERSDATA/DATA[@ID='rep_siteloja']/@VALUE"/>
								</td>	
							</tr>
						</table>
					</td>
		...
		<xsl:template name="GerarTotal">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" style="border:1px Solid #818181;">									
				...
				<tr  bgcolor="#E9E9E9">
					...
					<td width="65" align="right" style="padding-right:5px;font-size:10px;font-family:Arial;">
						<b>
						<xsl:value-of select="parent::node()/parent::node()/@CURRENCYSYMBOL"/> 
						<xsl:text>&#160;</xsl:text> 
		...
		<xsl:template name="GerarItem">			
			...
			<tbody >
				...
				<td><xsl:text>&#160;</xsl:text><xsl:value-of select="@DESCRIPTION"/></td>
		...
		<xsl:template name="GerarCabecalhoListaPecas">
			...
			<thead>				
				<tr bgcolor="#E9E9E9" align="center">
					<th width="4%" height="30"><b>Ítem</b></th>
					<th width="4%" ><b>Rep</b></th>
					<th width="8%"><b>Qtd</b></th>
					<th width="18%"><b>Referência</b></th>
					<th width="37%"><b>Descrição</b></th>
					<th width="21%"><b>Dimensões</b></th>					
					<th width="8%"><b>Preço</b></th>				
				</tr>
			</thead>				
