	...
	<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
		...
		<xsl:template match="LISTING">
			<html generator="ProMob.Cadastro">
				<head>
					<title>Parceiro GE Monogram</title>
										...
										<tbody>
											<tr>
												<td style="PADDING-RIGHT: 10px; PADDING-LEFT: 10px; PADDING-BOTTOM: 10px; PADDING-TOP: 10px" width="1%">
													<img src="%pastasistema%/identity/logo_ge_monogram.png" width="100" />
												</td>
												<td style="PADDING-RIGHT: 10px; PADDING-LEFT: 10px; PADDING-BOTTOM: 10px; PADDING-TOP: 10px" valign="top">
													<table cellspacing="0" cellpadding="3" width="100%" border="0">
														<tbody>
															...
															<tr>
																<td width="100%" align="left" style="color:#535353;"><b>Nome:</b> GE Monogram </td>
															</tr>
															<tr>
																<td width="100%" align="left" style="color:#535353;"><b>SAC:</b> 0800 200-0060 </td>
															</tr>
															<tr>
																<td width="100%" align="left" style="color:#535353;"><b>E-mail:</b> gemonogram@mabebr.com </td>
															</tr>
															<tr>
																<td width="100%" align="left" style="color:#535353;"><b>Website:</b> www.gemonogram.com.br </td>
															</tr>
														</tbody>
													</table>
												</td>
