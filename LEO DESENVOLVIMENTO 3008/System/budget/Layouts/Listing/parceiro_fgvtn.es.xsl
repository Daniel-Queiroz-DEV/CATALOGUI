			...
			<html generator="ProMob.Cadastro">
				...
				<body>
					<table align="center" border="0">
							...
							<tr>
								<td align="middle">
										...
										<tbody>
											<tr>
												<td style="PADDING-RIGHT: 10px; PADDING-LEFT: 10px; PADDING-BOTTOM: 10px; PADDING-TOP: 10px" width="1%">
													<img src="%pastasistema%/identity/parceiro_fgvtn.png" width="100" />
												</td>
												<td style="PADDING-RIGHT: 10px; PADDING-LEFT: 10px; PADDING-BOTTOM: 10px; PADDING-TOP: 10px" valign="top">
													<table cellspacing="0" cellpadding="3" width="100%" border="0">
														<tbody>
															<tr>
																<td colspan="2" valign="top" style="font-size:16px;height:30px;color:#556982;font-weight:bold;font-family:Arial;">Datos del Parcero</td>
															</tr>
															<tr>
																<td width="100%" align="left" style="color:#535353;"><b>Nombre:</b> FGVTN BRASIL </td>
															</tr>
															<tr>
											<td width="100%" align="left" style="color:#535353;"><b>SAC:</b> (0xx41) 2107-4411 </td>
										</tr>
															
															<tr>
											<td width="100%" align="left" style="color:#535353;"><b>E-mail:</b> fgvtn@fgvtn.com.br </td>
										</tr>
										<tr>
											<td width="100%" align="left" style="color:#535353;"><b>Website:</b> www.fgvtn.com.br </td>
										</tr>
														</tbody>
													</table>
												</td>
									...
									<table width="630" border="0">
										<tbody>
											<tr>
												<td style="FONT-WEIGHT: bold; FONT-SIZE: 12px; COLOR: #556982; PADDING-TOP: 20px; FONT-FAMILY: Arial" width="400">Fecha: 
													...
													<tbody>
														<tr>
															<td style="FONT-SIZE: 10px; WIDTH: 50%">
																<b>
																	<span style="COLOR: #535353" width="50%">Nombre: 
																	</span>
																</b>
															...
															<td style="FONT-SIZE: 10px; WIDTH: 50%">
																<b>
																	<span style="COLOR: #535353" width="50%">Dirección: 
																	</span>
																</b>
						...
						<tfoot id="FOOTER">
							<tr>
								<td align="middle">©Promob. Todos los derechos reservados. 
								</td>
							</tr>
						</tfoot>
