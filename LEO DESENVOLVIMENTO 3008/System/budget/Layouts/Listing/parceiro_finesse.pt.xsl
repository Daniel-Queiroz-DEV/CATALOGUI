										...
										<tbody>
											<tr>
												<td style="PADDING-BOTTOM: 10px; PADDING-LEFT: 10px; PADDING-RIGHT: 10px; PADDING-TOP: 10px" width="1%">
													<img src="%pastasistema%/identity/parceiro_finesse.jpg" width="100" height="27">
													</img> 
												</td>
														...
														<tbody>
															...
															<tr>
																<td style="COLOR: #535353" width="100%" align="left">
																	<b>Nome: </b>Finesse Alumínio B2B
																</td>
															</tr>
															<tr>
																<td style="COLOR: #535353" width="100%" align="left">
																	<b>Endereço: </b>Rua Severo Ravizzoni, Nº 1836, Flores da Cunha, RS
																</td>
															</tr>
															<tr>
																<td style="COLOR: #535353" width="100%" align="left">
																	<b>Telefone: </b>54 3929 4584
																</td>
															</tr>
															<tr>
																<td style="COLOR: #535353" width="100%" align="left">
																	<b>E-mail: </b> marcello@finesse.ind.br – vendas@finesse.ind.br
																</td>
															</tr>
														</tbody>
													</table>
