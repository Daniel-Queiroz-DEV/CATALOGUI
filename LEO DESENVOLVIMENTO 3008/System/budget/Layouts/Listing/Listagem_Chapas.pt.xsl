		...
		<xsl:template name="GerarItem">
					...
					<tr height="1" style="display:none">
						<td colspan="7" valign="top" align="right" >
							<table width="610" border="0" cellspacing="0" cellpadding="5" style="border-bottom:none;border-left:1px Solid #CECECE">
								...
								<tr bgcolor="#E9E9E9">
									<td align="center"><b>Cod Pai</b></td>
									<td align="center" style="border-left:1px Solid #CECECE"><b>Cod</b></td>
			...
			<xsl:if test="count(ITEMS) &lt;= 0" >
				...
				<tr>
					...
					<xsl:if test="@UNIQUEPARENTID &gt;= 0 " >
						<td align="center"><xsl:value-of select="@UNIQUEPARENTID"/></td>
					</xsl:if>
										
					<td align="center" style="border-left:1px Solid #CECECE"><xsl:value-of select="@UNIQUEID"/></td>
