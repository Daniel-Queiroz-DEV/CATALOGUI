										...
										<tbody>
											<tr>
												<td style="PADDING-RIGHT: 10px; PADDING-LEFT: 10px; PADDING-BOTTOM: 10px; PADDING-TOP: 10px" width="1%">
													<img height="90" src="%pastasistema%/Identity/logoBrasilPost.jpg" width="100">
													</img> 
												</td>
													...
													<table cellspacing="0" cellpadding="3" width="100%" border="0">
														<tbody>
															...
															<tr>
																<td style="COLOR: #535353" align="left" width="100%">
																	<b>E-mail: 
																	</b>luciano@moveisbrasilpost.com.br 
																</td>
															</tr>
															<tr>
																<td style="COLOR: #535353" align="left" width="100%">
																	<b>Website: 
																	</b>www.moveisbrasilpost.com.br
																</td>
															</tr>
														</tbody>
													</table>
