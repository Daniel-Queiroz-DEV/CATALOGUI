												...
												<td style="PADDING-RIGHT: 10px; PADDING-LEFT: 10px; PADDING-BOTTOM: 10px; PADDING-TOP: 10px" valign="top">
													<table cellspacing="0" cellpadding="3" width="100%" border="0">
														<tbody>
															...
															<tr>
											<td width="100%" align="left" style="color:#535353;"><b>Nome:</b> FGVTN BRASIL </td>
										</tr>
										
										<tr>
											<td width="100%" align="left" style="color:#535353;"><b>SAC:</b> (0xx41) 2107-44110 </td>
										</tr>
										<tr>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td style="FONT-WEIGHT: bold; FONT-SIZE: 12px; COLOR: #556982; PADDING-TOP: 20px; FONT-FAMILY: Arial" width="400">Data: 
												<xsl:value-of select="@DATE" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" /><span style="MARGIN: 0px; WIDTH: 10px"></span> Hora: 
												<xsl:value-of select="@HOUR" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" /></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </td>
