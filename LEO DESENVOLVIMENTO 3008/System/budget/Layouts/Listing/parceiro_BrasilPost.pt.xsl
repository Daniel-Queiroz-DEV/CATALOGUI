				...
				<tr>
					<td align="center">
						<table width="630" border="1" borderColor="#dfdfdf"  bgcolor="#EEEEEE" style="border 1px Solid #535353;border-collapse:collapse;">
							<tr>
								<td width="1%" style="padding:10px;"><img src="%pastasistema%/identity/logoBrasilPost.jpg" width="100" height="90"/></td>
								<td style="padding:10px;" valign="top">
									<table cellspacing="0" cellpadding="3" border="0" width="100%">
										...
										<tr>
											<td width="100%" align="left" style="color:#535353;"><b>Nome:</b> Brasil Post</td>
										</tr>
										<tr>
											<td width="100%" align="left" style="color:#535353;"><b>Contato:</b> Luciano Fernandes</td>
										</tr>
										<tr>
											<td width="100%" align="left" style="color:#535353;"><b>Telefone:</b> (018) 3903-0991</td>
										</tr>
										<tr>
											<td width="100%" align="left" style="color:#535353;"><b>E-mail:</b> luciano@moveisbrasilpost.com.br</td>
										</tr>
										<tr>
											<td width="100%" align="left" style="color:#535353;"><b>Website:</b> www.moveisbrasilpost.com.br</td>
										</tr>
									</table>
								</td>
							</tr>
