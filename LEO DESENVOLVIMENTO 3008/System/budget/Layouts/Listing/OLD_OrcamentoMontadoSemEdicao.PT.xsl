							...
							<tr>
								<td align="center">
									...
									<table border="0" width="100%">
										<tbody>
											<tr>
												<td style="FONT-FAMILY: Arial; COLOR: #808080; FONT-SIZE: 12px; FONT-WEIGHT: bold; PADDING-TOP: 20px" align="left" width="50%">Data: 
												...
												<td style="FONT-FAMILY: Arial; COLOR: #808080; FONT-SIZE: 12px; FONT-WEIGHT: bold; PADDING-TOP: 20px" width="50%" align="right">Orçamento
												</td>
											</tr>
										</tbody>
									</table>
								...
								<xsl:if test="count(ITEMSWITHOUTPRICE) &gt; 0">
									<tr>
										<td style="PADDING: 5px; COLOR: black; FONT-SIZE: 16px; text-align:center; " bgcolor="red">
											<b>Orçamento com itens sem preço. A Fábrica deve ser contactada 
											</b>
										</td>
									</tr>	
									<td valign="middle">
