				...
				<tr>
					<td align="center">
						<table width="630" border="1" borderColor="#dfdfdf"  bgcolor="#EEEEEE" style="border 1px Solid #535353;border-collapse:collapse;">
							<tr>
								<td width="1%" style="padding:10px;"><img src="%pastasistema%\Identity\parceiro_Zen.png" width="100" height="100" /></td>
								<td style="padding:10px;" valign="top">
									<table cellspacing="0" cellpadding="3" border="0" width="100%">
										<tr>
											<td colspan="2" valign="top" style="font-size:16px;height:30px;color:#808080;font-weight:bold;font-family:Arial;">Dados do Parceiro</td>
										</tr>
										<tr>
											<td width="100%" align="left" style="color:#535353;"><b>Nome:</b> Zen Acessórios para Móveis Ltda.</td>
										</tr>
										<tr>
											<td width="100%" align="left" style="color:#535353;"><b>Contato:</b> Contate o representante de sua Região. </td>
										</tr>
										<tr>
											<td width="100%" align="left" style="color:#535353;"><b>Telefone:</b> (0xx54) 3055 7553</td>
										</tr>
										<tr>
											<td width="100%" align="left" style="color:#535353;"><b>Website:</b> www.zendesign.com.br</td>
										</tr>
									</table>
								</td>
							</tr>
				...
				<tr>
					<td valign="center" >     
                        ...
                        <table width="630" border="0" cellspacing="0" cellpadding="0" style="border:1px Solid #818181;font-family:Tahoma;font-size:12px;border-collapse:collapse;">
                            <tr>
                                <td bgcolor="#EEEEEE" style="font-size:16px;padding:5px;color:#808080;border-bottom:1px Solid #818181"><b>Dados da loja:</b></td>
                            </tr>
                            <tr>
			...
			<xsl:for-each select="AMBIENTS/AMBIENT">
				...
				<xsl:if test="count(CATEGORIES/CATEGORY) &gt; 0" >
					<table width="630" cellspacing="0" cellpadding="0">
						<tr>
							<td colspan="6" style="font-size:12px;color:#808080;"><b><xsl:value-of select="@DESCRIPTION"/></b></td>
						</tr>
					</table>
		...
		<xsl:template name="GerarCabecalhoListaPecas">
			...
			<thead>				
				<tr bgcolor="#E9E9E9" align="center">
					...
					<th width="15%"><b>Referência</b></th>
					<th width="49%"><b>Descrição</b></th>
