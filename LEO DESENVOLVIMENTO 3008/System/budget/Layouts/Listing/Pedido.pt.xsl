	...
	<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
					...
					<tr id="BODY">
						<td valign="top">
							...
							<xsl:for-each select="AMBIENTS/AMBIENT">
								...
								<xsl:if test="count(CATEGORIES/CATEGORY) &gt; 0" >
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td style="text-align:left; " width="100%">
												<b>***** - Itens sem necessidade de preço, pois fazem parte de uma composição.</b>
											</td>
										</tr>
									</table>	
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0" style="border:1px Solid #CECECE;">
										...
										<tr  bgcolor="#E9E9E9">
											<td style="width:120px;color:#818181;line-height:20px;padding-left:5px;font-size:10px;font-family:Arial;font-weight:bold;">
												<b><span style="color:#535353">Total Preço Tabela:</span></b>
											</td>
											<td>
										...
										<tr  bgcolor="#E9E9E9">
											<td style="width:120px;color:#818181;line-height:20px;padding-left:5px;font-size:10px;font-family:Arial;font-weight:bold;">
												<b><span style="color:#535353">Total Preço Final:</span></b>
											</td>
											<td>
												<sub><hr width="100%" size="1" style="border:1px Dotted Black;"/></sub>
											</td>
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0" style="border:1px Solid #CECECE;">
								...
								<tr  bgcolor="#E9E9A9">
									<td style="width:200px;color:#818181;line-height:20px;padding-left:5px;font-size:10px;font-family:Arial;font-weight:bold;">
										<b><span style="color:#535353">Total Geral Preço Tabela:</span></b>
									</td>
									<td>
										<sub><hr width="100%" size="1" style="border:1px Dotted Black;"/></sub>
									</td>
								...
								<tr  bgcolor="#E9E9A9">
									<td style="width:200px;color:#818181;line-height:20px;padding-left:5px;font-size:10px;font-family:Arial;font-weight:bold;">
										<b><span style="color:#535353">Total Geral Preço Final:</span></b>
									</td>
									<td>
										<sub><hr width="100%" size="1" style="border:1px Dotted Black;"/></sub>
									</td>
						...
						<xsl:if test="count(ITEMSWITHOUTPRICE) &gt; 0">
							<tr>
								<td style="PADDING: 5px; COLOR: black; FONT-SIZE: 16px; text-align:center; " bgcolor="red" width="630">
									<b>Este Pedido possui itens abaixo relacionados sem preço. A Fábrica deve ser contactada, pois o valor final no pedido de compra pode divergir.
									</b>
								</td>
							</tr>	
		...
		<xsl:template name="GerarItem">
			...
			<tbody id="columns">
				...
				<xsl:variable name="IDITEM" select="@UNIQUEID" />	
				...
				<td id="orderprice" align="right" style="padding-right:1px;">								
					...
					<xsl:if test="count(PRICE) &gt; 0" >	
						...
						<xsl:if test="count(/LISTING/ITEMSWITHOUTPRICE/ITEM[@UNIQUEID = $IDITEM]) = 0">
							<xsl:if test="($valorPreco + $valorComponentes) = 0" >	
								<xsl:text>******</xsl:text>
							</xsl:if>
							<xsl:if test="($valorPreco + $valorComponentes) != 0" >	
					...
					<xsl:if test="count(PRICE) = 0" >	
						<xsl:variable name="valorComponentes" select="translate(PRICE/@TOTALCOMPONENTS, ',', '.')" />						
						<xsl:if test="count(/LISTING/ITEMSWITHOUTPRICE/ITEM[@UNIQUEID = $IDITEM]) = 0">
							<xsl:if test="($valorComponentes) = 0" >	
								<xsl:text>******</xsl:text>
							</xsl:if>
						</xsl:if>
