										...
										<tbody>
											<tr>
												<td style="PADDING-BOTTOM: 10px; PADDING-LEFT: 10px; PADDING-RIGHT: 10px; PADDING-TOP: 10px" width="1%">
													<img src="%pastasistema%/identity/parceiro_Obispa.png" width="100" height="100">
													</img> 
												</td>
										...
										<table style="BORDER-BOTTOM: #cacaca 1px solid; BORDER-LEFT: #cacaca 1px solid; MARGIN-TOP: 5px; BORDER-COLLAPSE: collapse; BORDER-TOP: #cacaca 1px solid; BORDER-RIGHT: #cacaca 1px solid" border="1" cellspacing="0" cellpadding="0" width="100%">
											<thead>
												<tr align="middle" bgcolor="#e9e9e9">
													...
													<th id="reference" width="10%">
														<b>Referência 
														</b>
													</th>
													
													<th id="ACAB_MET" width="5%">
														<b>Acab. Metálico
														</b>
													</th>
														
														<th id="ACAB_COURO" width="5%">
														<b>Acab. Couro
														</b>
													</th>
													
															<th id="ACAB_RES" width="5%">
														<b>Acab. Resina
														</b>
													</th>

													<th id="description" width="35%">
														<b>Descrição 
														</b>
													</th>
													<th id="size" width="10%">
...
<xsl:template name="GerarItem" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <tbody>
    ...
    <td>
      <xsl:text> </xsl:text>
      <xsl:value-of select="REFERENCES/ACAB_MET/@REFERENCE" />
    </td>
    
    <td>
      <xsl:text> </xsl:text>
      <xsl:value-of select="REFERENCES/ACAB_COURO/@REFERENCE" />
    </td>
    
    <td>
      <xsl:text> </xsl:text>
      <xsl:value-of select="REFERENCES/ACAB_RES/@REFERENCE" />
    </td>
