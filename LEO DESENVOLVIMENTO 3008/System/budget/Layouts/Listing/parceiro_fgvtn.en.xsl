											...
											<tr>
												...
												<td style="PADDING-RIGHT: 10px; PADDING-LEFT: 10px; PADDING-BOTTOM: 10px; PADDING-TOP: 10px" valign="top">
													<table cellspacing="0" cellpadding="3" width="100%" border="0">
														<tbody>
															<tr>
																<td colspan="2" valign="top" style="font-size:16px;height:30px;color:#556982;font-weight:bold;font-family:Arial;">Partner Data</td>
															</tr>
															<tr>
																<td width="100%" align="left" style="color:#535353;"><b>Name:</b> FGVTN BRASIL </td>
															</tr>
															<tr>
