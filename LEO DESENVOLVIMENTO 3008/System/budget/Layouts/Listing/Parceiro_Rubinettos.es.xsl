	...
	<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
		...
		<xsl:template match="LISTING">
			<html generator="ProMob.Cadastro">
				<head>
					<title>Parceiro Rubinettos</title>
										...
										<tbody>
											<tr>
												<td style="PADDING-RIGHT: 10px; PADDING-LEFT: 10px; PADDING-BOTTOM: 10px; PADDING-TOP: 10px" width="1%">
													<img height="27" src="%pastasistema%/Identity/logoRubinettos.jpg" width="100">
													</img> 
												</td>
												<td style="PADDING-RIGHT: 10px; PADDING-LEFT: 10px; PADDING-BOTTOM: 10px; PADDING-TOP: 10px" valign="top">
													<table cellspacing="0" cellpadding="3" width="100%" border="0">
														<tbody>
															<tr>
																<td style="FONT-WEIGHT: bold; FONT-SIZE: 16px; COLOR: #556982; FONT-FAMILY: Arial; HEIGHT: 30px" valign="top" colspan="2">Datos del parcero 
																</td>
															</tr>
															<tr>
																<td style="COLOR: #535353" align="left" width="100%">
																	<b>Nombre: 
																	</b>FALCOP COM. IMPO E EXPO LTDA. 
																</td>
															</tr>
															<tr>
																<td style="COLOR: #535353" align="left" width="100%">
															...
															<tr>
																<td style="COLOR: #535353" align="left" width="100%">
																	<b>Teléfono: 
																	</b>(0xx54) 3029 1847 / (0xx54) 8142 3196 
																</td>
															</tr>
															<tr>
																<td style="COLOR: #535353" align="left" width="100%">
																	<b>E-mail: 
																	</b>falecom@rubinettos.com.br 
																</td>
															</tr>
															<tr>
																<td style="COLOR: #535353" align="left" width="100%">
																	<b>Website: 
																	</b>www.rubinettos.com.br 
																</td>
															</tr>
														</tbody>
													</table>
										...
										<table style="BORDER-RIGHT: #cacaca 1px solid; BORDER-TOP: #cacaca 1px solid; MARGIN-TOP: 5px; BORDER-LEFT: #cacaca 1px solid; BORDER-BOTTOM: #cacaca 1px solid; BORDER-COLLAPSE: collapse" cellspacing="0" cellpadding="0" width="100%" border="1">
											<thead>
												<tr align="middle" bgcolor="#e9e9e9">
													...
													<th id="reference" width="5%">
														<b>Referencia 
														</b>
													</th>
													<th id="description" width="53%">
														<b>Descripción 
														</b>
													</th>
													<th id="size" width="15%">
