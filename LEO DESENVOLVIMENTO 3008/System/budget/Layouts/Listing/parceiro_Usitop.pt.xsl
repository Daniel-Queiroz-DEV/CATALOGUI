				...
				<tr>
					<td align="center">
						<table width="630" border="1" borderColor="#dfdfdf"  bgcolor="#EEEEEE" style="border 1px Solid #535353;border-collapse:collapse;">
							<tr>
								<td width="1%" style="padding:10px;"><img src="%pastasistema%\Identity\logousitop.jpg" width="100" height="100"/></td>
								<td style="padding:10px;" valign="top">
									<table cellspacing="0" cellpadding="3" border="0" width="100%">
										...
										<tr>
											<td width="100%" align="left" style="color:#535353;"><b>Nome:</b> Usitop® Puxadores Ltda </td>
										</tr>
										<tr>
											<td width="100%" align="left" style="color:#535353;"><b>Contato:</b> Irineu Jacon Junior  </td>
										</tr>
										<tr>
											<td width="100%" align="left" style="color:#535353;"><b>Telefone:</b> (0xx41) 3398 5754</td>
										</tr>
										<tr>
											<td width="100%" align="left" style="color:#535353;"><b>E-mail:</b> usitop@usitop.com.br</td>
										</tr>
										<tr>
											<td width="100%" align="left" style="color:#535353;"><b>Website:</b> www.usitop.com.br</td>
										</tr>
									</table>
								</td>
							</tr>
