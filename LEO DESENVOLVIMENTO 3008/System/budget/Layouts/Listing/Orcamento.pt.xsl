								...
								<td align="middle">
									<table style="BORDER-RIGHT: #cecece 1px solid; BORDER-TOP: #cecece 1px solid; BORDER-LEFT: #cecece 1px solid; BORDER-BOTTOM: #cecece 1px solid" width="100%" bgcolor="#eeeeee" border="0">
										<tbody>
											<tr>
												<td height="70">
													<img style="MARGIN-RIGHT: 300px" alt="" hspace="10" src="%pastasistema%\identity\logoCliente.png" align="left" border="0"></img> 
												</td>
												<td width="1%">
													<img alt="" src="%pastasistema%\identity\logoPromob.png" align="left" border="0"></img> 
												</td>
											</tr>
										</tbody>
									</table>
