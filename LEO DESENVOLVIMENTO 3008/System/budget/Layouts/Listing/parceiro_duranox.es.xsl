										...
										<tbody>
											<tr>
												<td style="PADDING-RIGHT: 10px; PADDING-LEFT: 10px; PADDING-BOTTOM: 10px; PADDING-TOP: 10px" width="1%">
													<img src="%pastasistema%/identity/parceiro_duranox.png" width="100" />
												</td>
												<td style="PADDING-RIGHT: 10px; PADDING-LEFT: 10px; PADDING-BOTTOM: 10px; PADDING-TOP: 10px" valign="top">
													<table cellspacing="0" cellpadding="3" width="100%" border="0">
														<tbody>
															...
															<tr>
																<td width="100%" align="left" style="color:#535353;"><b>Nombre:</b> DURANOX </td>
															</tr>
															<tr>
											<td width="100%" align="left" style="color:#535353;"><b>SAC:</b> (0xx46) 3524-3611  </td>
										</tr>
															
															<tr>
											<td width="100%" align="left" style="color:#535353;"><b>E-mail:</b> duranox@duranox.com.br </td>
										</tr>
										<tr>
											<td width="100%" align="left" style="color:#535353;"><b>Website:</b> www.duranox.com.br </td>
										</tr>
														</tbody>
													</table>
												</td>
