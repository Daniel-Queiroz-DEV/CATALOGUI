	...
	<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
		...
		<xsl:template match="LISTING">
			<html generator="ProMob.Cadastro">
				<head>
					<title>Parceiro Punto Mobile</title>
										...
										<tbody>
											<tr>
												<td style="PADDING-RIGHT: 10px; PADDING-LEFT: 10px; PADDING-BOTTOM: 10px; PADDING-TOP: 10px" width="1%">
													<img height="100" src="%pastasistema%/Identity/logopuntomobile.jpg" width="100">
													</img> 
												</td>
													...
													<table cellspacing="0" cellpadding="3" width="100%" border="0">
														<tbody>
															...
															<tr>
																<td style="COLOR: #535353" align="left" width="100%">
																	<b>E-mail: 
																	</b>comercial@puntomobile.com.br 
																</td>
															</tr>
															<tr>
																<td style="COLOR: #535353" align="left" width="100%">
																	<b>Website: 
																	</b>www.puntomobile.com.br 
																</td>
															</tr>
														</tbody>
													</table>
